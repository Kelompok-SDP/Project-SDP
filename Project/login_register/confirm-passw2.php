...
<head>
  ...
  <title>Uwenak Restoran | Email Confirmaion</title>
...
<div class="login-box">
  <div class="login-logo">
    <b>Email Confirmation</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Please enter your email so you can confirm your email first</p>
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          if(response=='Email Anda Tidak Di Temukan'){
            ...
            kirim();
            setTimeout(
              window.location.href = "confirmation.php?test=2"
             , 5000);
