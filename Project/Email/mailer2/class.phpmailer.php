...
class PHPMailer {
   ...
   * @var string
   */
  public $ContentType       = 'text/plain'; //hanya menerima tulisan text saja  kalau mau html --> text/html
   ...
   * @var string
   */
  public $From              = 'root@localhost'; //dari siapa 

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Uwenak Restoran';
